...
const Signup = (props: Props) => {
    return (
        ...
        <svg viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.5004 8C15.5004 9.65685 14.1572 11 12.5004 11C10.8435 11 9.50037 9.65685 9.50037 8C9.50037 6.34315 10.8435 5 12.5004 5C13.296 5 14.0591 5.31607 14.6217 5.87868C15.1843 6.44129 15.5004 7.20435 15.5004 8Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.0674 13H9.93336C9.61059 13.0004 9.29016 13.0548 8.98536 13.161C5.47535 14.372 8.81435 19 12.5004 19C16.1864 19 19.5254 14.372 16.0144 13.161C15.7099 13.0549 15.3898 13.0005 15.0674 13Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
        </svg>
        <input className="pl-2 outline-none border-none w-80" type="text" placeholder="UserName" />
        </div> 
        ...
        <input className="pl-2 outline-none border-none" type="text" placeholder="Comfirm Password" />
        </div>

        <button className="block w-full bg-indigo-600 mt-8 py-2 rounded-xl text-white font-semibold mb-4 ">Signup</button>
        <button className="flex items-center py-2 px-4 text-sm uppercase rounded bg-slate-100 hover:bg-slate-200 text-indigo-500 border border-transparent hover:border-transparent hover:text-gray-700 shadow-md hover:shadow-lg font-medium transition transform hover:-translate-y-0.5 w-full mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mr-3 ml-28" viewBox="0 0 48 48">
              ...
              <Link to="/signin"  className="text-sm ml-2 hover:text-blue-500 cursor-pointer font-bold">Signin</Link>
        </form>
        </div>
        </div>
        );
